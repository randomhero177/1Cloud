  ...
  this.handleComplete = function() {
  	...
  	function makeResponsive(isResp, respDim, isScale, scaleType) {
  		...
  		function resizeCanvas() {
  			...
  			canvas.style.width = dom_overlay_container.style.width = anim_container.style.width =  900+'px';
  			canvas.style.height = anim_container.style.height = dom_overlay_container.style.height = 400+'px';
