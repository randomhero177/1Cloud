(function(lib, img, cjs, ss, an) {
    ...
    (lib.Symbol17 = function(mode, startPosition, loop) {
        ...
        // Layer 1
        this.text = new cjs.Text("BROWSER/CLIENT", "normal 400 20px 'Roboto'", "#5C646D");
    ...
    (lib.Symbol16 = function(mode, startPosition, loop) {
        ...
        // Layer 1
        this.text = new cjs.Text("SERVER", "normal 400 20px 'Roboto'", "#5C646D");
        this.text.textAlign = "center";
        this.text.lineHeight = 30;
    ...
    (lib.Symbol5copy4 = function(mode, startPosition, loop) {
        ...
        // Layer 1
        this.text = new cjs.Text("Encrypted data is shared between the browser and the server", "normal 400 16px 'Roboto'", "#FFFFFF");
    ...
    }).prototype = getMCSymbolPrototype(lib.Symbol5copy4, new cjs.Rectangle(0, -12.6, 473, 25.3), null);
    ...
    (lib.Symbol5copy3 = function(mode, startPosition, loop) {
        ...
        // Layer 1
        this.text = new cjs.Text("The server sends back a digitally signed acknowledgement \nto start an SSL encrypted session", "normal 400 16px 'Roboto'", "#5C646D");
        this.text.lineHeight = 24;
    ...
    (lib.Symbol5copy2 = function(mode, startPosition, loop) {
        ...
        // Layer 1
        this.text = new cjs.Text("The browser checks whether it trusts the SSL certificate. \nIf so, it sends a message to the server", "normal 400 16px 'Roboto'", "#5C646D");
        this.text.lineHeight = 24;
    ...
    (lib.Symbol5copy = function(mode, startPosition, loop) {
        ...
        // Layer 1
        this.text = new cjs.Text("The server sends the browser a copy of its SSL certificate", "normal 400 16px 'Roboto'", "#5C646D");
        this.text.lineHeight = 24;
    ...
    (lib.Symbol5 = function(mode, startPosition, loop) {
        ...
        // Layer 1
        this.text = new cjs.Text("The browser requests that the web server identify itself", "normal 400 16px 'Roboto'", "#5C646D");
        this.text.lineHeight = 24;
        this.text.lineWidth = 483;
        this.text.parent = this;
        this.text.setTransform(2, -10.6);
    ...
    (lib.Symbol30 = function(mode, startPosition, loop) {
        ...
        this.frame_0 = function() {
            ...
            TweenMax.set(this.tint, {
                alpha: 0,
                scaleX: 1,
                scaleY: 1
            });
            TweenMax.set(this.st, {
                scaleX: 1,
                scaleY: 1,
                rotation: 0
            });
            TweenMax.set(this.q1, {
                scaleX: 1,
                scaleY: 1
            });
            ...
            function fl_MouseOverHandler() {
                TweenMax.to(root.tint, 0.2, {
                    alpha: 1,
                    scaleX: 1.15,
                    scaleY: 1.15,
                    ease: Power0.easeNone
                });
                TweenMax.to(root.st, 0.2, {
                    scaleX: 1.15,
                    scaleY: 1.15,
                    rotation: 180,
                    ease: Power0.easeNone
                });
                TweenMax.to(root.q1, 0.2, {
                    scaleX: 1.15,
                    scaleY: 1.15,
                    ease: Power0.easeNone
                });
            ...
            function fl_MouseOutHandler() {
                TweenMax.to(root.tint, 0.3, {
                    alpha: 0,
                    scaleX: 1,
                    scaleY: 1,
                    ease: Back.easeOut
                });
                TweenMax.to(root.st, 0.3, {
                    scaleX: 1,
                    scaleY: 1,
                    rotation: 0,
                    ease: Back.easeOut
                });
                TweenMax.to(root.q1, 0.3, {
                    scaleX: 1,
                    scaleY: 1,
                    ease: Back.easeOut
                });
    ...
    (lib.Symbol27 = function(mode, startPosition, loop) {
        ...
        this.frame_1 = function() {
            TweenMax.from(this.q1, 0.5, {
                x: "+=99.5",
                ease: Power0.easeNone,
                repeat: 4
            });

            TweenMax.to(this.q1, 1.5, {
                x: "-=99.5",
                ease: Power3.easeOut,
                delay: 2
            });
    ...
    (lib.Symbol21copy7 = function(mode, startPosition, loop) {
        ...
        // timeline functions:
        this.frame_0 = function() {
            TweenMax.set(this.q2, {
                alpha: 1,
                scaleX: 1,
                scaleY: 1
            });
            TweenMax.set(this.q3, {
                alpha: 1,
                x: -162
            });
        ...
        this.frame_1 = function() {
            ...
            TweenMax.from(this.q2, 0.6, {
                scaleX: 0.3,
                scaleY: 0.3,
                ease: Elastic.easeOut.config(1, 0.7),
                delay: 0.7
            });
            TweenMax.from(this.q2, 0.1, {
                alpha: 0,
                ease: Power0.easeNone,
                delay: 0.7
            });

            TweenMax.from(this.q3, 0.5, {
                x: "+=50",
                alpha: 0,
                ease: Expo.easeOut,
                delay: 0.7
    ...
    (lib.Symbol20 = function(mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(239).to({
            _off: false
        }, 0).wait(41));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(179).to({
            _off: false
        }, 0).wait(101));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(119).to({
            _off: false
        }, 0).wait(161));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(59).to({
            _off: false
        }, 0).wait(221));
    ...
    (lib.Symbol19 = function(mode, startPosition, loop) {
        ...
        this.frame_0 = function() {
            ...
            TweenMax.set(this.brw, {
                x: -399,
                alpha: 1
            });
            TweenMax.set(this.ser, {
                x: 411,
                alpha: 1
            });

            TweenMax.set(this.txt1, {
                y: 205,
                alpha: 1
            });
            TweenMax.set(this.txt2, {
                y: 205,
                alpha: 1
            });


            TweenMax.from(this.brw, 0.7, {
                x: "-=300",
                alpha: 0,
                ease: Expo.easeOut
            });
            TweenMax.from(this.txt1, 0.4, {
                y: "-=20",
                alpha: 0,
                ease: Expo.easeOut,
                delay: 0.4
            ...
            TweenMax.from(this.ser, 0.7, {
                x: "+=300",
                alpha: 0,
                ease: Expo.easeOut
            });
            TweenMax.from(this.txt2, 0.4, {
                y: "-=20",
                alpha: 0,
                ease: Expo.easeOut,
                delay: 0.4
            ...
            TweenMax.set(this.btn, {
                alpha: 1,
                scaleX: 1,
                scaleY: 1
            });
            TweenMax.from(this.btn, 0.8, {
                scaleX: 0.3,
                scaleY: 0.3,
                ease: Elastic.easeOut.config(1, 0.5),
                delay: 5
            });
            TweenMax.from(this.btn, 0.1, {
                alpha: 0,
                ease: Power0.easeNone,
                delay: 5
            });
        ...
        this.timeline.addTween(cjs.Tween.get(this.fade).wait(4).to({
            _off: false
        }, 0).wait(15));
        ...
        this.timeline.addTween(cjs.Tween.get(this.text).to({
            _off: true
        }, 5).wait(14));
