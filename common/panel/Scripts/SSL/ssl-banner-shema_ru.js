...
(lib.Symbol5copy4 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Теперь передаваемые данные зашифрованы и защищены", "normal 400 24px 'Roboto'", "#FFFFFF");
	this.text.lineHeight = 28;
	this.text.lineWidth = 469;
	this.text.parent = this;
	this.text.setTransform(2,-26.7);
	if(!lib.properties.webfonts['Roboto']) {
		lib.webFontTxtInst['Roboto'] = lib.webFontTxtInst['Roboto'] || [];
		lib.webFontTxtInst['Roboto'].push(this.text);
	}
...
(lib.Symbol5copy3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Сервер отправляет браузеру зашифрованную публичным ключом страницу", "normal 400 20px 'Roboto'", "#5C646D");
	this.text.lineHeight = 24;
	this.text.lineWidth = 476;
	this.text.parent = this;
	this.text.setTransform(2,-23.7);
	if(!lib.properties.webfonts['Roboto']) {
		lib.webFontTxtInst['Roboto'] = lib.webFontTxtInst['Roboto'] || [];
		lib.webFontTxtInst['Roboto'].push(this.text);
	}
...
(lib.Symbol5copy2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Браузер проверяет подлинность сертификата и отправляет свой публичный ключ серверу", "normal 400 20px 'Roboto'", "#5C646D");
	this.text.lineHeight = 24;
...
(lib.Symbol5copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Сервер отправляет браузеру копию своего SSL-сертификата", "normal 400 20px 'Roboto'", "#5C646D");
	this.text.lineHeight = 24;
	this.text.lineWidth = 483;
	this.text.parent = this;
	this.text.setTransform(2,-27.6);
	if(!lib.properties.webfonts['Roboto']) {
		lib.webFontTxtInst['Roboto'] = lib.webFontTxtInst['Roboto'] || [];
		lib.webFontTxtInst['Roboto'].push(this.text);
	}
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Браузер запрашивает веб-страницу по протоколу HTTPS", "normal 400 20px 'Roboto'", "#5C646D");
	this.text.lineHeight = 24;
	this.text.lineWidth = 483;
	this.text.parent = this;
	this.text.setTransform(2,-26.6);
	if(!lib.properties.webfonts['Roboto']) {
		lib.webFontTxtInst['Roboto'] = lib.webFontTxtInst['Roboto'] || [];
		lib.webFontTxtInst['Roboto'].push(this.text);
	}
