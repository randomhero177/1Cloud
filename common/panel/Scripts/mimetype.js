...
(function (self) {
  ...
  MimeType = {
    ...
    lookup: function (fname, include_charset, default_mime_type) {
      ...
      if (typeof include_charset === 'undefined') {
      ...
      if (typeof this.catalog[ext] !== 'undefined') {
  ...
  if (typeof self.cloudMimeTypes === 'undefined') {
    self.cloudMimeTypes = MimeType;
  } else {
    console.log('Window already has object cloudMimeTypes');
  }
