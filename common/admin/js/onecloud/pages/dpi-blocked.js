...
var Dpi = {
    ...
    item: {
        ...
        formSubmit: function (itemId, action, method) {
            var curForm = (method == 'AddToWhitelist') ? Dpi.modal.config.addToWhitelistForm : Dpi.modal.config.unlockForm,
    ...
    modal: {
        ...
        config: {
            ...
            addToWhitelistForm: document.getElementById('back-in-white-form'),
